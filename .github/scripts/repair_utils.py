...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Utilitaires de compatibilité Android Builder Studio.")
    parser.add_argument("--gradle-for", dest="agp_version", help="Affiche la version Gradle recommandée pour une version AGP.")
    parser.add_argument("--minimum-gradle-for", dest="minimum_agp_version", help="Affiche la version Gradle minimale pour une version AGP.")
    args = parser.parse_args()
    if args.agp_version:
        _, recommended, _ = compatible_gradle_for_agp(args.agp_version)
        print(recommended)
    elif args.minimum_agp_version:
        minimum, _, _ = compatible_gradle_for_agp(args.minimum_agp_version)
        print(minimum)
    else:
        parser.print_help()
        sys.exit(2)
